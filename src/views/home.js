	...
	<section id="welcome">
		<div class="hero layout">
			...
			<div class="glass welcome">
				...
				${until(loadStats(), lineLoader())}
				${isLogged ? null : html`<a class="action cta" href="/login">Sign in to create a quiz</a>`}
			</div>
		</div>
...
async function loadStats() {
	...
	return html`<p>
		Home to ${stats} quizzes in ${Object.keys(categories).length} categories. <a href="/browse">Browse all quizzes</a>.
	</p>`;
}
